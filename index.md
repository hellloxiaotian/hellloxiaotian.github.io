...
<wbr>Tian Chunwei, Associate Professor at Northwestern Polytechnical University (NPU) from July 2021, Ph.D. advisor. Member of the National Engineering Laboratory for Integrated Big Data Application Technology in Aerospace, Ground, and Marine Systems. He obtained his Ph.D. from Harbin Institute of Technology (HIT) in January 2021, served as a Research Fellow at City University of Hong Kong, and a Postdoctoral Researcher at NPU. He was mentored by Professor Xu Yong (a national-level talent from HIT), Professor Zuo Wangmeng (a New Century Talent from the Ministry of Education), and Professor Zhang Yanning (a national-level talent from NPU). From 2022 to 2024, he was recognized as one of the world's top 2% scientists, a provincial-level talent, and a Rising Star at NPU. His research focuses on video/image restoration and recognition, image generation, and more. He has published over 80 papers in international journals/conferences such as IEEE Trans, Pattern Recognition, Neural Networks, Information Fusion, and ICASSP. He has authored three monographs and one textbook. Notably, his work includes 6 ESI highly cited papers (3 of which are hot papers), 4 cover papers in top journals, 5 benchmark papers in the international super-resolution field, and one paper whose technology was purchased for commercial application in CT machines by a U.S. medical imaging company, and another applied to Apple smartphones. He has received the Best Paper Award from the top journal Pattern Recognition in the international pattern recognition field, the Blog Paper Award from the International Signal Processing Association, the Second Prize in the Natural Science Award from the Chinese Society of Image and Graphics (1st author), the Youth Science and Technology Award (1st author), and the Third Prize in the Science and Technology Award (1st author). He serves as an editorial board member/guest editor for several SCI journals, including CAAII Transactions on Intelligence Technology, IEEE TFS, and IEEE TCE.<wbr>
