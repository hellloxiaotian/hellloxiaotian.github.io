...
## Journal papers (期刊论文)
- Wang T, Liu Y, Yin Q, Geng J, Chen J, Yin X, Wang Y, Shang X, **Tian C\***, **Wang Y\***， **Peng J\***, Enhencing discoveries of molecular QTL stuides with small smaple size using summary statistic imputation [J]. Briefings in Bioinformatics, 2021. (SCI-IF:11.622) (Accepted)  
